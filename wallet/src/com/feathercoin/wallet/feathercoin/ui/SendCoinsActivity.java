...
public final class SendCoinsActivity extends AbstractWalletActivity
{
	...
	private void handleIntent(final Intent intent)
	{
		...
		if ((Intent.ACTION_VIEW.equals(action) || NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)) && intentUri != null && "feathercoin".equals(scheme))
		{
			try
			{
				final FeathercoinURI feathercoinUri = new FeathercoinURI(null, intentUri.toString());
				address = feathercoinUri.getAddress().toString();
				addressLabel = feathercoinUri.getLabel();
				amount = feathercoinUri.getAmount();
			}
