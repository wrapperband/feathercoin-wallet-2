...
public class BlockchainServiceImpl extends android.app.Service implements BlockchainService
{
	...
	private static final String TAG = "Feathercoin"+BlockchainServiceImpl.class.getSimpleName();
	...
	private void notifyCoinsReceived(final Address from, final BigInteger amount)
	{
		...
		final int precision = Integer.parseInt(prefs.getString(Constants.PREFS_KEY_FTC_PRECISION, Integer.toString(Constants.FTC_PRECISION)));
		...
		private void check()
		{
			...
			if (hasEverything && peerGroup == null)
			{
                ...
                try {
                    ...
                    Log.e("Feathercoin", "There's no method: " + e.getLocalizedMessage());
                    Log.e("Feathercoin", "Feathercoinj issue.  We're going to ignore this for now and just try and return nicely.");
                    return;
                }
	...
	public void notifyWidgets()
	{
        ...
        try {
            ...
            Log.e("Feathercoin", "App server appears dead - Runtime Exception when running getAppWidgetIds.  Returning..");
            return;
        }
