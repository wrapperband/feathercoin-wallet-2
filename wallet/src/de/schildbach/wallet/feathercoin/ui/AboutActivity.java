...
public final class AboutActivity extends SherlockPreferenceActivity
{
	...
	private static final String KEY_ABOUT_CREDITS_FEATHERCOINJ = "about_credits_feathercoinj";
	...
	protected void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_FEATHERCOINJ).setTitle(getString(R.string.about_credits_feathercoinj_title, VersionMessage.LITECOINJ_VERSION));
		findPreference(KEY_ABOUT_CREDITS_FEATHERCOINJ).setSummary(Constants.CREDITS_FEATHERCOINJ_URL);
	...
	public boolean onPreferenceTreeClick(final PreferenceScreen preferenceScreen, final Preference preference)
	{
		...
		else if (KEY_ABOUT_CREDITS_FEATHERCOINJ.equals(key))
		{
			startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(Constants.CREDITS_FEATHERCOINJ_URL)));
			finish();
		}
